    ...
    <div className="flex flex-wrap -mx-2">
      <div className="w-full xl:w-1/2 px-2">
        ...
        <div className="mb-5">
          ...
          <Badge color="blue" className="ltr:mr-2 rtl:ml-2 rtl:ml-2">
            1
          </Badge>

          <Badge color="gray" className="ltr:mr-2 rtl:ml-2 rtl:ml-2">
            2
          </Badge>

          <Badge color="green" className="ltr:mr-2 rtl:ml-2 rtl:ml-2">
            3
          </Badge>
